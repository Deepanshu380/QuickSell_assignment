    ...
    <>
      <div className="card-top">
        <div className="card-header">
          <h5>
            {text == "Backlog" ? (
              <SiCodereview fontSize="1rem" style={{ color: "#fd5c63" }} />
            ) : text == "Todo" ? (
              <GoDot fontSize="1.2rem" />
            ) : text == "In progress" ? (
              <TbProgressDown fontSize="1.2rem" style={{ color: "orange" }} />
            ) : text == "Done" ? (
              ...
              <MdCancel fontSize="1.2rem" style={{ color: "gray" }} />
            ) : text == "Urgent" ? (
              ...
              <LuSignalHigh fontSize="1.4rem" />
            ) : text == "Medium" ? (
              <PiCellSignalMedium fontSize="1.4rem" />
            ) : text == "Low" ? (
              <LuSignalLow fontSize="1.4rem" style={{ fontWeight: "bold" }} />
            ) : text == "No Priority" ? (
            ...
            <span style={{ color: "gray", fontWeight: "700" }}>{count}</span>
          </h5>
          <div className="photo-icons">
            <IoIosAdd style={{ marginRight: "1rem" }} fontSize="large" />
            <BsThreeDots fontSize="large" />
          </div>
        </div>
      </div>
    </>
